...
SECRET_KEY = '&fnm48$=_4p)y=*erm2g16mg2+$+kdoa=aw6a6x7_l)-m6g@n2'
...
INSTALLED_APPS = [
    ...
    'users.apps.UsersConfig',  # Приложение Users для регистрации
...
MIDDLEWARE = [
    ...
    'debug_toolbar.middleware.DebugToolbarMiddleware',  # Дебаг
]
